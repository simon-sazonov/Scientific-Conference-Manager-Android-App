...
import com.example.mobileappproject.databinding.ActivitySearchConferenceBinding
...
class SearchConference : AppCompatActivity() {

    private lateinit var binding: ActivitySearchConferenceBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySearchConferenceBinding.inflate(layoutInflater)
        ...
        binding.conferenceListView.onItemClickListener = AdapterView.OnItemClickListener { _, _, position, _ ->
            ...
            val intent = Intent(this, ConferencePage::class.java).apply {
                ...
                putExtra("conferenceTitle", selectedConference.title)
                putExtra("conferenceStartDate", selectedConference.startDate)
                putExtra("conferenceEndDate", selectedConference.endDate)
            }
