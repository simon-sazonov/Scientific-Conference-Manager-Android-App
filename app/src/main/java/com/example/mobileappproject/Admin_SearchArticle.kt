...
import com.example.mobileappproject.databinding.ActivityAdminSearchArticleBinding
...
class Admin_SearchArticle : AppCompatActivity() {

    private val db = FirebaseFirestore.getInstance()
    private lateinit var binding: ActivityAdminSearchArticleBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAdminSearchArticleBinding.inflate(layoutInflater)
        ...
        binding.articleListView.onItemClickListener = AdapterView.OnItemClickListener { _, _, position, _ ->
            ...
            val intent = Intent(this, Article_Edit::class.java).apply {
